...
### 9. C++中public/private/protect区别，详细介绍一下？
...
### 11. 在成员函数中调用delete this会出现什么问题，对象还可以使用吗？
...
### 22. C++如何阻止一个类被实例化？一般在什么时候将构造函数声明为private？
